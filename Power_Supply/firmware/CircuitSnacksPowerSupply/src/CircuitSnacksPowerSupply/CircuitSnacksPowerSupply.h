...
#define EEPROM_ADDRESS_VOLTAGE_READBACK_SLOPE_CAL 0
#define EEPROM_ADDRESS_VOLTAGE_SET_SLOPE_CAL 4
#define EEPROM_ADDRESS_CURRENT_READBACK_OFFSET_CAL 8
#define EEPROM_ADDRESS_CURRENT_READBACK_SLOPE_CAL 12
#define EEPROM_ADDRESS_CURRENT_LIMIT_OFFSET_CAL 16
#define EEPROM_ADDRESS_CURRENT_LIMIT_SLOPE_CAL 20
